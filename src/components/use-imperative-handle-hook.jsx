...
const UseImperativeHandleHook = () => {
    ...
    return (
        <div className='container'>
            ...
            <u><li>To call a function of a child component from a parent component, you can use the `useImperativeHandle` hook in combination with `forwardRef`. This allows the parent to access methods defined in the child component.</li></u>
            <br />
