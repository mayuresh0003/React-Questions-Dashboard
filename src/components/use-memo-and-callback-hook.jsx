...
const UseMemoAndCallbackHook = () => {
    ...
    return (
        <div className='container'>
            ...
            <h5>Question2: When should you use useMemo hook?</h5>
            <u>
            ...
            <h5>Question3: What is the difference between useMemo and useCallback?</h5>
            <u>
            ...
            <h5>Question4: How does useMemo differ from useState??</h5>
            <u>
            ...
            <h5>Question 5: What is useCallback in react?</h5>
            <u>
                <li>
            ...
            <h5>Question 6: When should you not use useCallback or useMemo hook?</h5>
            <u>
